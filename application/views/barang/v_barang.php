...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            <div class="card-body">
                <button type="button" class="btn btn-secondary mb-3" id="tambahBarang">
                ...
                <table class="table table-striped table-bordered" id="tableBarang">
                    ...
                    foreach ($barang as $row) {
                        ...
                        <tbody>
                            ...
                            <td><?= $row->satuan ?></td>
                            <td>
                                <a data-kodeBarang="<?= $row->kode_barang; ?>" class="col-sm mx-auto btn btn-sm btn-warning edit"><svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                        <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                                        <path d="M9 7h-3a2 2 0 0 0 -2 2v9a2 2 0 0 0 2 2h9a2 2 0 0 0 2 -2v-3" />
                                        <path d="M9 15h3l8.5 -8.5a1.5 1.5 0 0 0 -3 -3l-8.5 8.5v3" />
                                        <line x1="16" y1="5" x2="19" y2="8" />
                                    </svg>Edit</a>
                                <a data-kodeBarang="<?= $row->kode_barang; ?>" data-href="<?= site_url(); ?>barang/hapusBarang/<?= $row->kode_barang; ?>" class="col-sm mx-auto btn btn-sm btn-danger hapus"><svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                        <path stroke="none" d="M0 0h24v24H0z" fill="none" />
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a href="#" id="hapusBarang" type="button" class="btn btn-danger">Yes, delete all my data</a>
            </div>
        </div>
    </div>
</div>
...
<script type="text/javascript">
    $(function() {
        $("#tambahBarang").click(function() {
            ...
            $("#loadFormInputBarang").load("<?= site_url(); ?>barang/inputBarang");
        });
    });
    $(".edit").click(function() {
